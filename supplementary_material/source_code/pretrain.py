...
def arg_parser():
    ...
    parser.add_argument("--save_model_dir", default = 'pretrain_models/model')
    parser.add_argument("--save_out_dir", default = 'pretrain_results')
...
def train(args):
    ...
    with tf.device('/device:GPU:0'):
        ...
        face_cartoon_list = utils.load_image_list(face_photo_dir)
        scenery_cartoon_dir = 'folder_that_store_scenery_cartoon_images'
        scenery_cartoon_list = utils.load_image_list(scenery_photo_dir)
        '''
